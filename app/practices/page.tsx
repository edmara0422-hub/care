...
const PRACTICES: Practice[] = [
  ...
  },
  {
    ...
    subtitle: 'Identidade não é fixa — ela evolui com você',
    duration: '15 min',
    category: ['identidade'],
    color: '#FFB800',
    icon: '🪞',
    tag: 'Autoconhecimento · Identidade · Evolução',
    steps: [
      { title: 'O mito da identidade fixa', body: 'A maioria das pessoas acredita que "eu sou assim". Mas a neurociência mostra que o cérebro se reconfigura constantemente. Quem você era aos 15 não é quem você é hoje. E quem você é hoje não é quem será em 5 anos.\n\nIsso não é instabilidade — é crescimento.' },
      { title: 'Quem eu era?', body: 'Pense em quem você era 5 anos atrás.\n\n- O que você acreditava que era importante?\n- O que te fazia feliz?\n- O que te dava medo?\n- Do que você se orgulhava?\n\nEscreva sem julgamento. Aquela pessoa fez o melhor que podia com o que tinha.' },
      { title: 'Quem eu sou agora?', body: 'Agora, hoje:\n\n- O que realmente me importa? (Não o que deveria importar)\n- O que me dá energia?\n- O que eu não tolero mais?\n- O que mudou em mim que me surpreende?\n\nSeja honesto — não existe resposta errada.' },
      { title: 'O que mudou?', body: 'Compare as duas versões. O que mudou?\n\nAlgumas mudanças foram escolhas conscientes. Outras aconteceram sem você perceber. Ambas são válidas.\n\nA pergunta não é "mudei demais?" — é "as mudanças me aproximaram de quem eu quero ser?"' },
      { title: 'Quem eu quero me tornar?', body: 'Não um plano de carreira. Não expectativas dos outros.\n\nQue tipo de PESSOA você quer ser?\n- Como você quer tratar as pessoas?\n- O que você quer sentir ao deitar à noite?\n- Que experiências você quer ter?\n\nEsse "eu futuro" é sua bússola.' },
      { title: 'Uma coisa por semana', body: 'Escolha UMA coisa que o "eu futuro" faria e que o "eu atual" ainda não faz. Comece essa semana.\n\nIdentidade não muda por reflexão — muda por ação repetida. Você se torna quem você pratica ser.' },
    ],
  },
  {
    id: 'life-chapters',
    title: 'Capítulos da Vida',
    subtitle: 'Sua história tem fases — e tudo bem mudar de capítulo',
    duration: '20 min',
    category: ['identidade'],
    color: '#3A86FF',
    icon: '📖',
    tag: 'Narrativa · Propósito · Transições',
    steps: [
      { title: 'Você é uma história em andamento', body: 'Psicologia narrativa (Dan McAdams, Northwestern) mostra que a forma como contamos nossa própria história determina nossa saúde mental. Pessoas que veem sentido nas dificuldades têm menos depressão e mais resiliência.\n\nVocê não é um personagem fixo — é o autor.' },
      { title: 'Nomeie seus capítulos', body: 'Divida sua vida em capítulos até agora. Dê um título para cada um:\n\nEx:\nCap 1: "A criança que queria agradar" (0-12)\nCap 2: "Descobrindo quem eu não era" (13-18)\nCap 3: "Tentando ser adulto" (19-24)\nCap 4: "Reconstrução" (25-agora)\n\nNão precisa ser bonito. Precisa ser verdadeiro.' },
      { title: 'O capítulo atual', body: 'Que capítulo você está vivendo AGORA?\n\n- Qual seria o título?\n- Qual é o tema central? (busca, cura, construção, perda, descoberta, transição?)\n- Como você se sente dentro dele?\n- Esse capítulo está bom ou precisa mudar?' },
      { title: 'Momentos de virada', body: 'Em cada capítulo, existem momentos que mudaram tudo. Decisões, perdas, encontros, crises.\n\nIdentifique 2-3 momentos de virada na sua história. O que eles te ensinaram?\n\nMuitas vezes, os piores momentos foram os que mais transformaram.' },
      { title: 'O próximo capítulo', body: 'Se você pudesse escrever o próximo capítulo da sua vida, como seria o título?\n\nO que aconteceria nele?\nComo o personagem principal (você) se sentiria?\n\nIsso não é fantasia — é direção. Saber para onde quer ir é o primeiro passo.' },
    ],
  },
  {
    id: 'dream-excavation',
    title: 'Escavação de Sonhos',
    subtitle: 'Resgatar o que você queria antes de te dizerem o que querer',
    duration: '15 min',
    category: ['identidade'],
    color: '#E040FB',
    icon: '💫',
    tag: 'Sonhos · Propósito · Resgate',
    steps: [
      { title: 'Sonhos enterrados', body: 'Quando criança, você sonhava sem filtro. Depois vieram as expectativas: família, escola, sociedade, mercado de trabalho. Muitos sonhos foram enterrados não porque eram impossíveis, mas porque alguém disse que "não era prático".\n\nVamos desenterrar.' },
      { title: 'O que você queria ser?', body: 'Aos 8 anos, o que você queria ser? Aos 12? Aos 16?\n\nNão o que era "realista" — o que fazia seus olhos brilharem.\n\nPor trás de cada sonho há um VALOR: o astronauta queria explorar, o médico queria cuidar, o artista queria criar. O sonho muda. O valor permanece.' },
      { title: 'Sonhos atuais (sem filtro)', body: 'Se dinheiro, tempo e opinião dos outros não existissem, o que você faria?\n\n- Onde moraria?\n- Como passaria seus dias?\n- Com quem estaria?\n- O que criaria?\n\nEscreva RÁPIDO, sem censurar. O julgamento vem depois (ou nunca).' },
      { title: 'O que te impede?', body: 'Para cada sonho, pergunte: o que me impede?\n\n- Medo? (de quê exatamente?)\n- Dinheiro? (quanto realmente precisaria?)\n- Opinião dos outros? (de quem especificamente?)\n- "Não sou bom o suficiente"? (quem disse?)\n\nA maioria dos impedimentos são histórias que contamos, não fatos.' },
      { title: 'Um passo ridiculamente pequeno', body: 'Escolha 1 sonho. Qual é o menor passo possível em direção a ele?\n\nNão "mudar de carreira". Talvez "pesquisar por 15 minutos" ou "conversar com alguém que faz isso".\n\nSonhos não morrem de impossibilidade. Morrem de inação.' },
    ],
  },
  {
    id: 'shadow-work',
    title: 'Trabalho de Sombra',
    subtitle: 'Conhecer as partes de você que você esconde',
    duration: '15 min',
    category: ['identidade'],
    color: '#1a1a1a',
    icon: '🌑',
    tag: 'Jung · Autoconhecimento profundo',
    steps: [
      { title: 'O que é a Sombra', body: 'Carl Jung chamou de "Sombra" as partes de nós que reprimimos: raiva, inveja, medo, desejo, vulnerabilidade. Não porque são ruins — porque aprendemos que eram inaceitáveis.\n\nO problema: o que você não reconhece em si, te controla.' },
      { title: 'O que te irrita nos outros?', body: 'Liste 3 comportamentos que te irritam MUITO em outras pessoas.\n\nAgora a parte difícil: existe alguma versão disso em você que você não aceita?\n\nEx: "Odeio gente egoísta" → será que você tem medo de ser visto como egoísta e por isso nunca se permite priorizar?' },
      { title: 'O que você esconde?', body: 'Que parte de você nunca aparece em público?\n\n- A raiva que você engole?\n- A tristeza que finge não existir?\n- A ambição que parece "demais"?\n- A necessidade de carinho que parece "fraqueza"?\n\nEssas partes não são defeitos. São partes não integradas.' },
      { title: 'Diálogo com a sombra', body: 'Escolha uma dessas partes escondidas. Imagine que ela é uma pessoa sentada à sua frente.\n\nPergunte:\n- "O que você precisa?"\n- "Quando você apareceu pela primeira vez?"\n- "O que acontece quando eu te ignoro?"\n\nEscreva as respostas que vierem — sem censurar.' },
      { title: 'Integração', body: 'Integrar a sombra não é "se tornar" ela. É reconhecer que ela existe e tem uma função.\n\nA raiva protege seus limites. O medo protege o que importa. A vulnerabilidade permite conexão.\n\nVocê não precisa eliminar nada de si — precisa entender.' },
    ],
  },
  {
    id: 'inner-critic',
    title: 'O Crítico Interno',
    subtitle: 'Calar a voz que diz que você não é suficiente',
    duration: '10 min',
    category: ['identidade', 'depressao'],
    color: '#FF4466',
    icon: '🗣️',
    tag: 'Autocrítica · Autocompaixão · TCC',
    steps: [
      { title: 'Todo mundo tem um', body: 'O crítico interno é aquela voz que diz: "Você não é bom o suficiente", "Todo mundo percebe que você é uma fraude", "Você vai falhar".\n\nEle não é "a verdade". É um padrão mental aprendido — geralmente na infância — que se tornou automático.' },
      { title: 'Identifique a voz', body: 'Qual é a frase mais frequente do seu crítico interno?\n\n- "Você é incompetente"\n- "Ninguém gosta de você de verdade"\n- "Você devia estar fazendo mais"\n- "Você é fraco/fraca"\n\nEscreva exatamente como ele fala com você.' },
      { title: 'De quem é essa voz?', body: 'Muitas vezes, o crítico interno fala com a voz de alguém do passado: um pai exigente, um professor, um bully, uma relação tóxica.\n\nVocê internalizou a voz de outra pessoa e agora acha que é sua.\n\nDe quem é essa voz originalmente?' },
      { title: 'O teste do amigo', body: 'Se seu melhor amigo te dissesse: "Eu me sinto incompetente" — você responderia "É, você é mesmo"?\n\nNunca.\n\nEntão por que aceitar isso do seu crítico interno? Ele não merece mais credibilidade do que você daria a um estranho na rua.' },
      { title: 'Responda ao crítico', body: 'Escreva uma resposta direta ao seu crítico:\n\n"Eu ouço você, mas você está errado. Eu estou fazendo o que posso. Eu mereço compaixão, não julgamento."\n\nRepita isso toda vez que a voz aparecer. Com o tempo, ela perde força.' },
    ],
  },
  {
    id: 'seasons-of-self',
    title: 'Estações de Quem Você É',
    subtitle: 'Cada fase da vida pede uma versão diferente de você',
    duration: '12 min',
    category: ['identidade'],
    color: '#00D4A0',
    icon: '🍂',
    tag: 'Mudança · Aceitação · Crescimento',
    steps: [
      { title: 'Você não é a mesma pessoa', body: 'Seus gostos mudam. Seus amigos mudam. Seus sonhos mudam. Suas prioridades mudam. E tudo bem.\n\nMuita gente sofre porque se apega a uma versão antiga de si mesma. "Eu sempre fui assim." Mas a vida é movimento.' },
      { title: 'O que você já deixou para trás?', body: 'Liste coisas que já foram centrais na sua identidade e hoje não são mais:\n\n- Amizades que se desfizeram\n- Hobbies que perderam sentido\n- Crenças que mudaram\n- Objetivos que não fazem mais sentido\n\nDeixar ir não é perder — é abrir espaço.' },
      { title: 'O que está nascendo?', body: 'Que interesses novos estão surgindo? Que valores estão ficando mais fortes? Que tipo de pessoa te atrai agora?\n\nÀs vezes a nova versão de você já está aparecendo, mas você ainda não deu permissão para ela existir.' },
      { title: 'Luto da versão anterior', body: 'É normal sentir saudade de quem você era. A energia de antes. A simplicidade. As certezas.\n\nPermita-se sentir esse luto. Ele não significa que você piorou — significa que você mudou. E toda mudança tem uma perda embutida.' },
      { title: 'Permissão para evoluir', body: 'Dê a si mesmo, em voz alta ou por escrito:\n\n"Eu me permito mudar. Eu me permito querer coisas diferentes. Eu me permito não saber quem eu sou agora. Eu me permito estar em construção."\n\nVocê não precisa estar pronto. Precisa estar em movimento.' },
    ],
  },
  {
    id: 'legacy-letter',
    title: 'Carta para o Futuro',
    subtitle: 'O que você quer que sua vida tenha significado?',
    duration: '15 min',
    category: ['identidade'],
    color: '#7B8FF8',
    icon: '✉️',
    tag: 'Propósito · Legado · Sentido',
    steps: [
      { title: 'O exercício mais poderoso', body: 'Viktor Frankl mostrou que pessoas que encontram sentido suportam quase tudo. Este exercício te obriga a olhar para o que REALMENTE importa — além do dia a dia.' },
      { title: 'Imagine daqui a 30 anos', body: 'Você tem 30 anos a mais do que hoje. Olha para trás e vê sua vida.\n\n- Do que você se orgulha?\n- O que gostaria de ter feito mais?\n- Que relações foram as mais importantes?\n- Que momentos brilham na memória?' },
      { title: 'Escreva a carta', body: 'Escreva uma carta do seu EU FUTURO para o seu EU DE HOJE:\n\n"Querido/a [seu nome],\n\nEu sei que agora parece difícil, mas quero que você saiba que...\n\nO que mais importou foi...\n\nNão perca tempo com...\n\nNunca se esqueça de..."\n\nEscreva o que vier. Sem editar.' },
      { title: 'O que essa carta te diz?', body: 'Releia a carta. O que o seu eu futuro está pedindo para você AGORA?\n\nGeralmente é algo simples: estar presente, ser mais gentil consigo, parar de adiar, valorizar quem está perto.\n\nEssa carta é um mapa.' },
    ],
  },
  {
    id: 'masks-we-wear',
    title: 'As Máscaras que Usamos',
    subtitle: 'Quem é você quando ninguém está olhando?',
    duration: '10 min',
    category: ['identidade'],
    color: '#C8C8C8',
    icon: '🎭',
    tag: 'Autenticidade · Vulnerabilidade · Persona',
    steps: [
      { title: 'Persona vs Essência', body: 'Jung chamou de "persona" a máscara social que usamos. Todo mundo tem. O problema é quando você confunde a máscara com quem você é.\n\nO forte que nunca pode chorar. O engraçado que nunca pode estar triste. O competente que nunca pode errar.' },
      { title: 'Liste suas máscaras', body: 'Que máscaras você usa?\n\n- No trabalho: "o que resolve tudo"?\n- Na família: "o forte"?\n- Com amigos: "o tranquilo"?\n- Online: "o que tem tudo sob controle"?\n\nPara cada máscara: o que você esconde por trás dela?' },
      { title: 'O custo da máscara', body: 'Manter uma máscara exige ENERGIA. Muita.\n\nQuanto de exaustão, solidão ou desconexão que você sente vem de estar performando em vez de sendo?\n\nBurnout muitas vezes não é excesso de trabalho — é excesso de performance.' },
      { title: 'Quem sou sem máscara?', body: 'Sozinho, à noite, sem audiência:\n\n- O que você sente de verdade?\n- O que quer de verdade?\n- O que te assusta de verdade?\n- O que te faz chorar?\n\nEssa pessoa é você. E ela merece ser vista.' },
      { title: 'Um ato de autenticidade', body: 'Esta semana, em 1 situação, tire a máscara por 10 segundos:\n\n- Diga "não estou bem" quando não estiver\n- Peça ajuda quando precisar\n- Admita que não sabe\n\nVulnerabilidade não é fraqueza — é a única forma de conexão real.' },
    ],
  },
  // MAIS ANSIEDADE
  {
    ...
    subtitle: 'Enfrentar o medo aos poucos — o que realmente funciona',
    duration: '10 min + prática',
    category: ['ansiedade'],
    color: '#7B8FF8',
    icon: '🪜',
    tag: 'TCC · Exposição gradual · Fobia',
    steps: [
      { title: 'Por que evitar piora tudo', body: 'Cada vez que você evita algo por medo, o cérebro aprende: "isso é perigoso". A evitação AUMENTA a ansiedade a longo prazo.\n\nExposição gradual ensina ao cérebro que a ameaça não é real. É o tratamento mais eficaz para ansiedade que existe.' },
      { title: 'Escolha um medo', body: 'O que você tem evitado? Falar em público? Ligar para alguém? Ir a um lugar? Ter uma conversa difícil?\n\nEscolha UM medo que está limitando sua vida.' },
      { title: 'Construa a escada', body: 'Crie 5-7 degraus do MENOS assustador ao MAIS:\n\nEx (medo social):\n1. Pensar em ir a uma festa (10/100)\n2. Ir e ficar 15 min (30/100)\n3. Falar com 1 pessoa conhecida (45/100)\n4. Falar com 1 desconhecido (60/100)\n5. Ir sozinho e ficar 1 hora (80/100)' },
      { title: 'Comece pelo degrau 1', body: 'Faça o primeiro degrau. Fique na situação até a ansiedade CAIR (não fugir quando subir). Geralmente cai em 15-30 minutos.\n\nO cérebro aprende: "sobrevivi. Não era tão ruim." Só então suba para o próximo degrau.' },
      { title: 'Registre', body: 'Depois de cada exposição:\n- Ansiedade esperada (0-100)\n- Ansiedade real (0-100)\n- O que aprendi?\n\nA ansiedade real é SEMPRE menor que a esperada. Esse dado acumulado é o que cura.' },
    ],
  },
  // MAIS TDAH
  {
    ...
    subtitle: 'Fontes saudáveis para o cérebro que precisa de estímulo',
    duration: '10 min',
    category: ['tdah'],
    color: '#00D4A0',
    icon: '🧪',
    tag: 'TDAH · Dopamina · Regulação',
    steps: [
      { title: 'O cérebro TDAH e dopamina', body: 'TDAH é fundamentalmente um problema de regulação de dopamina. O cérebro precisa de mais estímulo para funcionar. Por isso busca scroll infinito, comida, compras, drama.\n\nA solução não é eliminar estímulos — é ter OPÇÕES melhores prontas.' },
      { title: 'Monte seu cardápio', body: 'Liste atividades que te dão prazer/estímulo em 3 categorias:\n\n🟢 Rápidas (2-5 min): música alta, 20 pulos, meme favorito, tomar sol, cheiro de café\n\n🟡 Médias (15-30 min): caminhar, desenhar, cozinhar, dançar, jogo rápido\n\n🔴 Longas (1h+): exercício, projeto criativo, sair com amigo, natureza' },
      { title: 'A regra do antes', body: 'ANTES de ir para o celular/scroll/comida por impulso, olhe seu cardápio. Escolha uma alternativa.\n\nNão vai funcionar 100% das vezes. Se funcionar 30%, já é uma mudança enorme em semanas.' },
      { title: 'Stack de dopamina', body: 'Combine uma tarefa chata com uma fonte de dopamina:\n\n- Estudar + música\n- Limpeza + podcast\n- E-mails + café especial\n\nO TDAH precisa de "isca" para iniciar. Isso é isca consciente.' },
    ],
  },
  // MAIS DEPRESSÃO
  {
    id: 'meaning-making',
    title: 'Encontrando Sentido',
    subtitle: 'Quando tudo parece vazio — a busca que cura',
    duration: '15 min',
    category: ['depressao', 'identidade'],
    color: '#FFB800',
    icon: '🔥',
    tag: 'Frankl · Logoterapia · Propósito',
    steps: [
      { title: 'Vazio não é fraqueza', body: 'A sensação de "nada faz sentido" é um dos sintomas mais dolorosos da depressão. Não é preguiça, não é ingratidão — é o cérebro em modo de desligamento.\n\nViktor Frankl sobreviveu a Auschwitz e descobriu: quem encontra sentido sobrevive a quase tudo.' },
      { title: '3 fontes de sentido (Frankl)', body: 'Frankl identificou 3 formas de encontrar sentido:\n\n1. CRIAÇÃO: fazer algo que importa (trabalho, arte, projeto, cuidar de alguém)\n2. EXPERIÊNCIA: viver algo que importa (amor, natureza, beleza, conexão)\n3. ATITUDE: como você enfrenta o sofrimento inevitável\n\nQual dessas está mais acessível para você agora?' },
      { title: 'O que te faz esquecer do tempo?', body: 'Quando foi a última vez que você estava tão absorvido em algo que esqueceu das horas?\n\nIsso é um sinal. Não ignore. Mesmo que pareça "bobo" ou "improdutivo" — ali tem sentido.' },
      { title: 'Para quem você importa?', body: 'Sentido muitas vezes está nas relações. Para quem sua existência faz diferença?\n\nUm amigo, um animal, um projeto, uma causa, uma pessoa que você ainda vai conhecer.\n\nVocê não precisa ser importante para o mundo. Precisa ser importante para alguém — inclusive para si mesmo.' },
      { title: 'O menor sentido possível', body: 'Não precisa "encontrar seu propósito de vida". Isso paralisa.\n\nHoje: qual é uma coisa que vale a pena fazer? Tomar sol. Cozinhar uma refeição. Enviar uma mensagem.\n\nSentido se constrói em atos mínimos repetidos.' },
    ],
  },
]
